<template>
	<view class="range-slider" :style="'width:' + width + 'rpx;height:' + height + 'rpx'">
		<view class="range-bar" :style="'width:100%;height:' + barHeight + 'rpx' ">
			<view class="range-bar-bg" :style="'background:' + backgroundColor + ''"></view>
			<view class="range-bar-progress" :style="'margin-left:' + progressBarLeft + 'rpx;width:' + progressBarWidth + 'rpx;background:' + activeColor + ''+ (round ? ';border-radius: 1000rpx;': '')"></view>
		</view>
		...
		<view
			...
			data-tag="minBlock"
		>
			<view class="fs-22" style="margin-top: -30rpx;">{{startNumber}}</view>
			<slot name="minBlock"></slot>
		</view>
		<view
			class="block"
			:class="{ active: isMaxActive, transparent: barTransparent }"
			...
			data-tag="maxBlock"
		>
			<view v-if="isOneNumber == 2" class="fs-22" style="margin-top: -30rpx;">{{endNumber}}</view>
